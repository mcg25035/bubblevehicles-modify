...
execute if score @e[type=marker, tag=btemp.origin, limit=1] bvehicle.action matches 0 run function bubblevehicles:vehicles/police_cruiser/module/action_button/siren/idle
