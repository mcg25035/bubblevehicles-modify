...
execute if score @e[type=marker, tag=btemp.origin, limit=1] bvdata.timer3 matches 0 run function bubblevehicles:vehicles/ambulance/module/action_button/siren/slow/left
execute if score @e[type=marker, tag=btemp.origin, limit=1] bvdata.timer3 matches 1 run function bubblevehicles:vehicles/ambulance/module/action_button/siren/slow/right
